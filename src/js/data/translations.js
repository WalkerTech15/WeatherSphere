...
export const I18N = {
  en: {
    ...
    photoGeneric: "Illustrative photo — not verified as this exact place",
    photoGenericShort: "Illustrative",
    photoAltGeneric: "Illustrative photo for {place}",
  ...
  fr: {
    ...
    photoGeneric: "Photo d'illustration — lieu exact non vérifié",
    photoGenericShort: "Illustration",
    photoAltGeneric: "Photo d'illustration pour {place}",
