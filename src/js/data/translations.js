...
export const I18N = {
  en: {
    ...
    setAnim: "Weather animations",
    setAnimSub:
      "Rain and wind motion on the map, and snow, storms and waves on the home card. They only appear when the real weather or place calls for them.",
    animSwitch: "Animate the weather",
    animSwitchSub: "Turn off to keep everything still.",
    animReduced: "Off because your device is set to reduce motion.",
    mapAnimate: "Animate",
  ...
  fr: {
    ...
    setAnim: "Animations météo",
    setAnimSub:
      "Mouvement de la pluie et du vent sur la carte, et neige, orages et vagues sur la carte d'accueil. Ils n'apparaissent que si la météo ou le lieu réels le justifient.",
    animSwitch: "Animer la météo",
    animSwitchSub: "Désactivez pour tout garder immobile.",
    animReduced: "Désactivé car votre appareil est réglé pour réduire les animations.",
    mapAnimate: "Animer",
