...
export const I18N = {
  en: {
    ...
    tipLayerClouds: "Cloud cover from OpenWeatherMap",
    tipLayerCloudsUnavailable: "Cloud cover is unavailable right now",
    mapLayerUnavailable: "Unavailable",
    mapCloudsLoading: "Loading cloud cover…",
    mapCloudsReady: "Cloud cover is shown on the map.",
    mapCloudsProvider: "Cloud data ©",
    mapCloudsUnavailable: "Cloud cover is unavailable right now.",
    mapCloudsTimeout: "Cloud cover timed out — select the layer again to retry.",
    mapCloudsOffline: "You're offline — cloud cover is unavailable.",
    mapCloudsRateLimited: "Too many cloud requests — try again in a minute.",
    mapCloudsError: "Cloud cover could not be loaded.",
  ...
  fr: {
    ...
    tipLayerClouds: "Couverture nuageuse fournie par OpenWeatherMap",
    tipLayerCloudsUnavailable: "La couverture nuageuse est indisponible pour le moment",
    mapLayerUnavailable: "Indisponible",
    mapCloudsLoading: "Chargement de la couverture nuageuse…",
    mapCloudsReady: "La couverture nuageuse est affichée sur la carte.",
    mapCloudsProvider: "Données de nuages ©",
    mapCloudsUnavailable: "La couverture nuageuse est indisponible pour le moment.",
    mapCloudsTimeout: "Délai dépassé pour les nuages — resélectionnez la couche pour réessayer.",
    mapCloudsOffline: "Vous êtes hors ligne — couverture nuageuse indisponible.",
    mapCloudsRateLimited: "Trop de requêtes de nuages — réessayez dans une minute.",
    mapCloudsError: "La couverture nuageuse n'a pas pu être chargée.",
