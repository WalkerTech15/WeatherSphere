...
export async function setMapLayer(type, { offset = overlay.offset } = {}) {
  /* Air Quality and Humidity have no MapTiler weather layer (WEATHER_LAYER_IDS
     deliberately excludes both — see weather-layers.js) and each follows its
     own point-reading flow instead of the ramp-layer one below. */
